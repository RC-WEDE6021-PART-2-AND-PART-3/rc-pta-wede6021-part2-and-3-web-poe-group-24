...
$collection_items = [
    ['image' => 'shop clothing/02ae30a9d316ee47d1d760f034e3c3a4.jpg', 'title' => 'Oversized Hoodie', 'price' => '$75', 'link' => 'product.php?id=1'],
    ['image' => 'shop clothing/1201de3ecb040a9012cc889d5e25d4f5.jpg', 'title' => 'Graphic Tee', 'price' => '$35', 'link' => 'product.php?id=2'],
    ['image' => 'shop clothing/480edc8f2fefed1b8afe2f1df0d5cace.jpg', 'title' => 'Cargo Pants', 'price' => '$85', 'link' => 'product.php?id=3'],
    ['image' => 'shop clothing/c4b32fc9ae9001f69e53d42f5f89b352.jpg', 'title' => 'Street Cap', 'price' => '$25', 'link' => 'product.php?id=4'],
    ['image' => 'shop clothing/cd8dddbe4075f087e48d6eb74c60ac03.jpg', 'title' => 'Denim Jacket', 'price' => '$95', 'link' => 'product.php?id=5'],
    ['image' => 'shop clothing/ef8cdbe8e63327b304adc871d30fa71f.jpg', 'title' => 'Sneaker High', 'price' => '$120', 'link' => 'product.php?id=6'],
    ['image' => 'shop clothing/f306974e0cddc1ff13789139837f08ec.jpg', 'title' => 'Bomber Jacket', 'price' => '$110', 'link' => 'product.php?id=7'],
    ['image' => 'shop clothing/Screenshot_20260414_104307_Instagram.jpg', 'title' => 'Beanie Hat', 'price' => '$20', 'link' => 'product.php?id=8'],
    ['image' => 'shop clothing/Screenshot_20260414_104315_Instagram.jpg', 'title' => 'Track Pants', 'price' => '$60', 'link' => 'product.php?id=9'],
    ['image' => 'shop clothing/5102ceeb064591ddfd29bb0d333b1506.jpg', 'title' => 'Chain Necklace', 'price' => '$40', 'link' => 'product.php?id=10'],
];
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Bpleasant. – All Products</title>
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .item-info { position: absolute; bottom: 0; left: 0; right: 0; background: rgba(255,255,255,0.95); padding: 12px; text-align: center; opacity: 0; transition: opacity .3s; }
    .grid-item:hover .item-info { opacity: 1; }
    .item-info h3 { font-size: 13px; font-weight: 600; margin: 0; color: #111; }
    .item-info p { font-size: 12px; font-weight: 700; color: #111; margin: 4px 0 0; }
